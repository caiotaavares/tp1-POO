...
public class CadastroCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, -1, -1));
        ...
        getContentPane().add(ClienteT, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, -1));
        ...
        getContentPane().add(CorretorT, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 90, -1, -1));
        ...
        getContentPane().add(CodigoIT, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, -1, -1));

        DataAT.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        DataAT.setForeground(new java.awt.Color(255, 255, 255));
        DataAT.setText("Data do aluguel:");
        getContentPane().add(DataAT, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 150, -1, -1));

        DataDT.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        DataDT.setForeground(new java.awt.Color(255, 255, 255));
        DataDT.setText("Data de Devolução:");
        getContentPane().add(DataDT, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 160, -1));

        PagamentoMT.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        PagamentoMT.setForeground(new java.awt.Color(255, 255, 255));
        PagamentoMT.setText("Pagamento mensal:");
        getContentPane().add(PagamentoMT, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, -1, -1));
        ...
        getContentPane().add(ValorTT, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, -1, -1));
        ...
        getContentPane().add(FormaPT, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, -1, -1));

        SegurosT.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        SegurosT.setForeground(new java.awt.Color(255, 255, 255));
        SegurosT.setText("Seguro Contratado:");
        getContentPane().add(SegurosT, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, -1, -1));
        ...
        getContentPane().add(CartaoT, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, -1, -1));

        NomeT.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        NomeT.setForeground(new java.awt.Color(255, 255, 255));
        NomeT.setText("Nome:");
        getContentPane().add(NomeT, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, -1, -1));
        ...
        getContentPane().add(BandeiraT, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, -1, -1));
        ...
        getContentPane().add(NumeroT, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, -1, -1));
        ...
        getContentPane().add(ClienteText, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 230, 30));
        getContentPane().add(CorretorText, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 90, 230, 30));
        ...
        getContentPane().add(CodigoIText, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 120, 30));
        ...
        getContentPane().add(DataAText, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 150, 150, 30));
        getContentPane().add(DataDText, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 190, 150, 30));
        getContentPane().add(PagamentoMText, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, 120, 30));
        getContentPane().add(ValorTText, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, 120, 30));
        getContentPane().add(SegurosText, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 290, 190, 30));
        getContentPane().add(NomeText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, 220, 30));
        getContentPane().add(BandeiraText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 220, 30));
        getContentPane().add(NumeroText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 470, 220, 30));
        ...
        getContentPane().add(FormaPBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 230, 150, 30));
